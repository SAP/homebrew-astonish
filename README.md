...
```bash
brew update
brew upgrade astonish
```

## Uninstallation

```bash
brew uninstall astonish
brew untap sap/astonish
```
...
For more information about Astonish, visit the [main repository](https://github.com/SAP/astonish).
